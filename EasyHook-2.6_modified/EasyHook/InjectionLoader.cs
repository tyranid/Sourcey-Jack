...
#pragma warning disable 0618
    ...
    public class InjectionLoader : MarshalByRefObject
    {
        ...
        public static int Main(String InParam)
        {
            ...
            if (_appDomain == null)
            {
                ...
                Uri codeBase = new Uri(currentAssembly.CodeBase);
                adSetup.ApplicationBase = Path.GetDirectoryName(codeBase.LocalPath);

                _appDomain = AppDomain.CreateDomain("running", null, adSetup);
            }
            
            return _appDomain.ExecuteAssemblyByName(currentAssembly.FullName, null, InParam);                        
        }
        ...
        {            
            ...
            System.Diagnostics.Debug.WriteLine("In Main");

            if ((args.Length == 0) || (args[0] == null))
            {
                System.Diagnostics.Debug.WriteLine("Invalid paramter to Main");
                return 0;
            }

            String InParam = args[0];            
